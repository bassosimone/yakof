...
The context variable models boundary conditions. Often times, these
boundary conditions are expressed as probability distributions.
"""
    ...
    def sample(
        ...
        *,
        ...
        if force_sample or subset is None or nr < len(subset):
            assert nr > 0
            return [(1 / nr, r) for r in list(self.rvc.rvs(size=nr))]  # type: ignore
